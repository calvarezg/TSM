...
using TallerSoftwareMantenible.Negocio.RendimientosPorDescuento.ConFunciones;

namespace TallerSoftwareMantenible.Negocio.UnitTests.RendimientosPorDescuento.ConFunciones
{
    [TestClass]
