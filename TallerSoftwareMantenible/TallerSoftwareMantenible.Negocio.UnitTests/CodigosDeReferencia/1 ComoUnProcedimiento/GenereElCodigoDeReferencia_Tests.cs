...
using TallerSoftwareMantenible.Negocio.CodigosDeReferencia.ComoUnProcedimiento;

namespace TallerSoftwareMantenible.Negocio.UnitTests.CodigosDeReferencia.ComoUnProcedimiento
{
    [TestClass]
