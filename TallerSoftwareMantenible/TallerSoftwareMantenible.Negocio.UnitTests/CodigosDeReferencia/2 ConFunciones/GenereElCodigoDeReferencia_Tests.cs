...
using TallerSoftwareMantenible.Negocio.CodigosDeReferencia.ConFunciones;

namespace TallerSoftwareMantenible.Negocio.UnitTests.CodigosDeReferencia.ConFunciones
{
    [TestClass]
